  ...
  return (
    <section id="contact" className="py-24 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-4 font-display text-gray-900">Asegura la Compra de tu Vivienda</h2>
          <p className="text-xl text-gray-600 font-sans">Permite que nuestro equipo legal audite tu próxima operación inmobiliaria. Llena el formulario para comenzar el blindaje.</p>
        </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="flex flex-col gap-2">
              <label className="font-semibold text-gray-700 font-sans">Ubicación del inmueble</label>
          ...
          <div className="flex flex-col gap-2">
            <label className="font-semibold text-gray-700 font-sans">Etapa de la compra (Buscando, Oferta, Contrato)</label>
